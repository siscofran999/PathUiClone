...
public abstract class ParallaxRecylerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public abstract void onBindViewHolderImpl(RecyclerView.ViewHolder viewHolder, ParallaxRecylerAdapter<T> adapter, int i);

    public abstract RecyclerView.ViewHolder onCreateViewHolderImpl(ViewGroup viewGroup, ParallaxRecylerAdapter<T> adapter, int i);

    public abstract int getItemCountImpl(ParallaxRecylerAdapter<T> adapter);
    ...
    public ParallaxRecylerAdapter(List<T> data) {
        mData = data;
    }
